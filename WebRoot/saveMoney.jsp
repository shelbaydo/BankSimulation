...
<html>
  <head>
    ...
    <title>My JSP 'saveMoney.jsp' starting page</title>
  ...
  <body>
  <form action="${pageContext.request.contextPath}/saveMoneyDo.jsp" method="post">
  	 请输入卡号：<input type="text" name = "cno"/><br/>
